...
class Personne(AbstractUser, models.Model):
    ...
    poids = models.CharField(default=" ", max_length=50)
    groupeSanguin = models.CharField(default=" ", max_length=50)
    specialite = models.CharField(default=" ", max_length=50)
    bureau = models.CharField(default=" ", max_length=50)
    photoProfil = models.ImageField(upload_to="users", blank=True, default=None, null=True)
    #NumeroHopital = models.CharField(default=" ", max_length=50,  blank=True,  null=True)
    NumeroService = models.CharField(default=" ", max_length=50,  blank=True, null=True)
    ...
    #service =models.ForeignKey("hopital.Service", verbose_name="docteur_service", on_delete=models.CASCADE, null=True, blank=True, default="1")
    def __str__(self):
